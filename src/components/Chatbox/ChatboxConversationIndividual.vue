<template>
  <div class="my-2">
    ...
    <div v-for="(bubble, index) in item?.bubbles" :key="index" class="my-2">
      ...
      <div
        v-if="!bubble.client"
        class="chatbox__body__user d-flex justify-content-end"
      >
        <!-- Begin::Time -->
        <div class="chatbox__body__user__time d-flex align-items-center">
          <p>{{ bubble.time }}</p>
        </div>
        <!-- End::Time -->

        <!-- Begin::Bubble -->
        <div class="chatbox__body__user__bubble">
          <!-- Begin::Bubble Name -->
          <p class="chatbox__body__user__bubble-name m-0" @click="handleDetail">
            {{ bubble.name }}
          </p>
          <!-- End::Bubble Name -->
          ...
          <!-- Begin::Bubble Channel -->
          <p
            class="chatbox__body__user__bubble-sosmed d-flex justify-content-end m-0"
          >
